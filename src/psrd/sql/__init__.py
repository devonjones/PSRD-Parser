...
from psrd.sql.mythic_spells import create_mythic_spell_details_table, create_mythic_spell_details_index
...
def create_db_v_2(conn, curs, ver, source=None):
	...
	create_mythic_spell_details_table(curs)
	create_mythic_spell_details_index(curs)
