...
./rules_parse.py -o ../local/ -b "Core Rulebook" -t "Prestige Classes" ../../../data/websites/Pathfinder\ psrd/paizo.com/pathfinderRPG/prd/prestigeClasses.html
./rules_parse.py -o ../local/ -b "Core Rulebook" -t "Gamemastering" ../../../data/websites/Pathfinder\ psrd/paizo.com/pathfinderRPG/prd/gamemastering.html
./rules_parse.py -o ../local/ -b "Core Rulebook" -t "Environment" ../../../data/websites/Pathfinder\ psrd/paizo.com/pathfinderRPG/prd/environment.html
./rules_parse.py -o ../local/ -b "Core Rulebook" -t "Creating NPCs" ../../../data/websites/Pathfinder\ psrd/paizo.com/pathfinderRPG/prd/creatingNPCs.html
./rules_parse.py -o ../local/ -b "Core Rulebook" -t "Magic Items" ../../../data/websites/Pathfinder\ psrd/paizo.com/pathfinderRPG/prd/magicItems.html
./rules_parse.py -o ../local/ -b "Core Rulebook" -t "Glossary" ../../../data/websites/Pathfinder\ psrd/paizo.com/pathfinderRPG/prd/glossary.html
