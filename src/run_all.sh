...
./rules_parse.py -o ../data/ -b "Core Rulebook" -t "Getting Started"    ~/Unison/data/websites/Pathfinder\ psrd/paizo.com/pathfinderRPG/prd/gettingStarted.html
./rules_parse.py -o ../data/ -b "Core Rulebook" -t "Classes"            ~/Unison/data/websites/Pathfinder\ psrd/paizo.com/pathfinderRPG/prd/classes.html
./rules_parse.py -o ../data/ -b "Core Rulebook" -t "Using Skills"       ~/Unison/data/websites/Pathfinder\ psrd/paizo.com/pathfinderRPG/prd/usingSkills.html
./rules_parse.py -o ../data/ -b "Core Rulebook" -t "Skill Descriptions" ~/Unison/data/websites/Pathfinder\ psrd/paizo.com/pathfinderRPG/prd/skillDescriptions.html
./rules_parse.py -o ../data/ -b "Core Rulebook" -t "Equipment"          ~/Unison/data/websites/Pathfinder\ psrd/paizo.com/pathfinderRPG/prd/equipment.html
./rules_parse.py -o ../data/ -b "Core Rulebook" -t "Additional Rules"   ~/Unison/data/websites/Pathfinder\ psrd/paizo.com/pathfinderRPG/prd/additionalRules.html
./rules_parse.py -o ../data/ -b "Core Rulebook" -t "Combat"             ~/Unison/data/websites/Pathfinder\ psrd/paizo.com/pathfinderRPG/prd/combat.html
./rules_parse.py -o ../data/ -b "Core Rulebook" -t "Magic"              ~/Unison/data/websites/Pathfinder\ psrd/paizo.com/pathfinderRPG/prd/magic.html
./rules_parse.py -o ../data/ -b "Core Rulebook" -t "Prestige Classes"   ~/Unison/data/websites/Pathfinder\ psrd/paizo.com/pathfinderRPG/prd/prestigeClasses.html
./rules_parse.py -o ../data/ -b "Core Rulebook" -t "Gamemastering"      ~/Unison/data/websites/Pathfinder\ psrd/paizo.com/pathfinderRPG/prd/gamemastering.html
./rules_parse.py -o ../data/ -b "Core Rulebook" -t "Environment"        ~/Unison/data/websites/Pathfinder\ psrd/paizo.com/pathfinderRPG/prd/environment.html
./rules_parse.py -o ../data/ -b "Core Rulebook" -t "Creating NPCs"      ~/Unison/data/websites/Pathfinder\ psrd/paizo.com/pathfinderRPG/prd/creatingNPCs.html
./rules_parse.py -o ../data/ -b "Core Rulebook" -t "Magic Items"        ~/Unison/data/websites/Pathfinder\ psrd/paizo.com/pathfinderRPG/prd/magicItems.html
./rules_parse.py -o ../data/ -b "Core Rulebook" -t "Glossary"           ~/Unison/data/websites/Pathfinder\ psrd/paizo.com/pathfinderRPG/prd/glossary.html

./skill_parse.py -o ../data/ -b "Core Rulebook" ~/Unison/data/websites/Pathfinder\ psrd/paizo.com/pathfinderRPG/prd/skills/*.html
