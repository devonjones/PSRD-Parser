...
def insert_central_index(curs, section_id=None, parent_id=None,
		...
		spell_domain_list_text=None, spell_component_text=None,
		spell_source=None,
	...
	values = [section_id, parent_id, parent_name, database,
		...
		spell_list_text, spell_domain_list_text, spell_component_text,
		spell_source, creature_type, creature_subtype, creature_super_race,
		creature_cr, creature_xp, creature_size, creature_alignment]
	sql = '\n'.join([
