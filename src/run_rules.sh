...
# Bestiary 3
#./rules_parse.py -o ../data/ -b "Bestiary 3" -t "Creature Types" ../web/paizo.com/pathfinderRPG/prd/bestiary3/creatureTypes.html
./rules_parse.py -o ../data/ -b "Bestiary 3" -t "Monster Advancement" ../web/paizo.com/pathfinderRPG/prd/bestiary3/monsterAdvancement.html
./rules_parse.py -o ../data/ -b "Bestiary 3" -t "Monster Cohorts" ../web/paizo.com/pathfinderRPG/prd/bestiary3/monsterCohorts.html
./rules_parse.py -o ../data/ -b "Bestiary 3" -t "Universal Monster Rules" ../web/paizo.com/pathfinderRPG/prd/bestiary3/universalMonsterRules.html
